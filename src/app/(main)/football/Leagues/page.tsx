...
const LeaguesPage = () => {
  ...
  const columnsLeague: ColumnsMeta[] = [{ field: 'league', header: 'League' }];
  const columnsLeagueRanking: ColumnsMeta[] = [
    { field: 'rank', header: 'Sıralama' },
    { field: 'team', header: 'Takım' },
    { field: 'play', header: 'Oynanan Maç' },
    { field: 'win', header: 'Galibiyet' },
    { field: 'lose', header: 'Mağlubiyet' },
    { field: 'point', header: 'Puan' },
  ];
